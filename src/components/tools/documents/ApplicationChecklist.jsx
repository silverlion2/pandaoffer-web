  ...
  return (
    <div className="space-y-8">
      ...
      <div className="p-4 bg-blue-50 rounded-xl border border-blue-200 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-blue-900 mb-1">Always Verify with Your University</p>
          <p className="text-sm text-blue-800/80">
            This checklist covers the standard documents required by most Chinese universities and the CSC scholarship. Individual programs may require additional forms or specific formats. <strong>Always verify the exact requirements on your target university&apos;s official admissions portal</strong>, as some requirements are only available after registration or through authorized agents.
          </p>
        </div>
      </div>
