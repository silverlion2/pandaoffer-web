...
import { Briefcase, MapPin, Building2, CheckCircle2, ChevronRight, Search, Globe2, AlertCircle } from 'lucide-react';
...
const DUMMY_JOBS = [
  ...
  },
  {
    ...
    company: 'DJI',
    location: 'Shenzhen',
    salary: '25k-40k RMB / month',
    type: 'Full-time',
    visaSponsored: true,
    logo: 'D',
    bg: 'bg-zinc-800',
    tags: ['Hardware', 'Sales', 'Z-Visa'],
  },
  {
    id: 4,
    title: 'Native English Teacher (University Level)',
    company: 'Zhejiang University',
    location: 'Hangzhou',
    salary: '18k-22k RMB / month',
    type: 'Full-time',
    visaSponsored: true,
    logo: 'Z',
    bg: 'bg-red-700',
    tags: ['Education', 'Housing Provided', 'Z-Visa'],
  }
];
...
export default function CareerBoard() {
  ...
  const cities = ['All', 'Beijing', 'Shanghai', 'Guangzhou', 'Shenzhen', 'Hangzhou', 'Chengdu'];
      ...
      <div className="max-w-5xl mx-auto px-4 space-y-12">
        ...
        <div className="text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-100 text-indigo-700 font-semibold text-sm">
            ...
            42 New Roles matching your profile
          </div>
            ...
            filteredJobs.map((job) => (
              ...
              >
                <div className="flex flex-col md:flex-row gap-6">
                  {/* Logo */}
                  <div className={`shrink-0 w-16 h-16 rounded-xl flex items-center justify-center text-white text-2xl font-bold ${job.bg}`}>
                    {job.logo}
                  </div>
